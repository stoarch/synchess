...
namespace SyncChess
{
    public class Game
    {
        ...
        public static void Main(string[] args)
        {
            ...
            {
                new Character(blueUnitTexture, blueUnitSelectedTexture, bluePos1, 0F, 0.8F, grid),
                new Character(blueUnitTexture, blueUnitSelectedTexture, bluePos2, 0F, 0.8F, grid),
                new Character(blueUnitTexture, blueUnitSelectedTexture, bluePos3, 0F, 0.8F, grid)
            };
        ...
        private static void DrawGridLegend()
        {
            for (int i = 0; i < 10; i++)
            {
                ...
                DrawText(i.ToString(), 710, 50 + 10 + i * 50, 20, new Color(0, 0, 0, 255));
            }
        }
        ...
        private static void DrawPathCost()
        {
            if (path != null && path.Count > 0)
            {
                ...
                DrawText("Path cost: " + pathCost, 700, 600, 20, new Color(0, 0, 0, 255));
            }
        }
